...
2.  **المحتوى المطلوب:**
* حل المعادلة العقدية الآتية: ${func}
  ...
  return (
    <div className="container section-padding func-changes-container">
      ...
      <div className="main-form fade-in fade-in-2 max-sm:flex-row">
        <h2 className="mb-[10px]">المعادلة:</h2>
        <div className="flex gap-[10px] ">
          <div className="main-input max-w-[80%]">
            <input dir="ltr" ref={functionRef} className="max-w-[100%]" />
            <div></div>
          </div>
        </div>
      </div>
